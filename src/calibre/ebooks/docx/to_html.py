...
# PG add list cleanup code
from calibre.ebooks.docx.lists import cleanup_lists
...
class Convert(object):
    ...
    def __call__(self):
        ...
        # We need to find where headings get put into divs, and make it happen
        # to subtitle also.
        # No divs at this point.
        ...
        # print('Converted stage 4:')
        # raw = etree.tostring(self.html, encoding='utf-8', doctype='<!DOCTYPE html>')
        # print(raw)
        ...
        for html_obj, obj in self.object_map.iteritems():
            ...
            # css classes tied to names and css params
            if style is not None:
                ...
                if css:
                    ...
                    cls = self.styles.class_name(css, None)
                    if cls:
        ...
        cleanup_lists(self.html, self.styles)
    ...
    def write(self, doc):
        ...
        # doctype='<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01//EN"' - requires xhtml to use it?
